...
All notable changes to **Antigravity Remote** are documented here, in reverse chronological order (latest first).
...
We are thrilled to announce the **first official release** of **Antigravity Remote**! This tool transforms your mobile device into a real-time wireless viewport for your Antigravity AI coding sessions.
...
Copyright (C) 2026 **Dmitry Gorbatko** ([@dgorbatko](https://github.com/dgorbatko))
